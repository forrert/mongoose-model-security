...
var strapCallback = function(mongoose, functionName) {
    var model = mongoose.Model;
    var func = model[functionName];
...
exports.registerHooks = function(mongoose, policy, securityManager) {
    _.forEach(findFunctions, function(functionName) {
        strapCallback(mongoose, functionName);
    });
